...
<section class="banner">
    <div class="img-banner">
        <img src="./image/banner/banner-index.jpg" alt="">
    </div>
    <div class="content-banner">
        ...
        <div class="title-banner mb-60">
            <span>Summer - Autumn Lookbook 2023</span>
        </div>
        <div class="mini-note-title-banner">
            <span>How to be a gentleman</span>
        </div>
        <div class="text-banner">
            <span>Ấn tượng, lịch lãm và đầy nam tính cùng với những xu hướng phụ kiện Hè Thu 2023 của Dbrand</span>
        </div>
    </div>
</section>
        ...
        <div class="box-content-product color-box-left" >
            <a href="index.php?page=product&method=western">
                <div class="img-product d-flex jtf-center">
                    <img class="ao_polo" src="./image/index-product (1).png" alt="">
                </div>
    ...
    <div class="box-product box-product-right">
        ...
        <div class="box-content-product">
            <a href="./list-detail-product.html">
                <div class="img-product d-flex jtf-center">
                    <img src="./image/index-product (2).png" alt="">
                </div>
                <div class="text-img-product">
                    <h2>Ví da nam</h2>
                    <p>230 sản phẩm</p>
        ...
        <div class="box-content-product color-box-right-gray">
            <a href="./list-detail-product.html">
                <div class="img-product d-flex jtf-center">
                    <img src="./image/index-product (3).png" alt="">
                </div>
                <div class="text-img-product">
                    <h2>Túi xách nam</h2>
                    <p>230 sản phẩm</p>
        ...
        <div class="box-content-product color-box-right-gray">
            <a href="./list-detail-product.html">
                <div class="img-product d-flex jtf-center">
                    <img src="./image/index-product (4).png" alt="">
                </div>
                <div class="text-img-product">
                    <h2>Thắt lưng nam</h2>
                    <p>230 sản phẩm</p>
            ...
            <div class="col-md-5">
                <div class="box-text-content">
                    <div class="note-text-content">
                        ...
                        <p>Seal out the cold</p>
                    </div>
                    <div class="text-content">
                        <p>Thay vì lo lắng “không có gì mặc vào mùa Thu-Đông”, hãy lo lắng về việc làm thế nào để có thể diện hết tất cả những bộ Suit thời thượng của Dbrand trong những ngày giá lạnh.</p>
                        <p>Đó cũng là điểm khác biệt lớn nhất trong sản phẩm của Dbrand so với các sản phẩm thông thường khác. Đối với những sản phẩm da thông thường, chúng được làm bằng những loại vải tổng hợp nên rất dễ bị gấp nếp.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="img-about-the-product">
                    <img src="./image/vest_nam.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="about-the-product quytrinh_home">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-7">
                <div class="img-about-the-product">
                    <img src="./image/cach-tao-ra-sp.png" alt="">
                </div>
            </div>
            <div class="col-md-3">
                <div class="box-text-content">
                    ...
                    <div class="text-content">
                        <p>Quá trình tạo nên một bộ Suit hoàn hảo là một nghệt thuật. Chúng được áp dụng những kĩ thuật truyền thống kết hợp với công nghệ hiện đại nhất. Cả quá trình được diễn ra một cách tỉ mỉ và cẩn thận. Khi sản phẩm đã được chế xuất, chúng sẽ được hoàn thiện thông qua bàn tay khéo léo của những người thợ may có kinh nghiệm lâu năm. Chính vì thế, bạn có thể cảm nhận rõ được "khí chất riêng" của những sản phẩm mà Dbrand mang lại.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="box-text-content">
                    ...
                    <div class="text-content">
                        <p>Dbrand mang đến cho người dùng những trải nghiệm tuyệt vời về các sản phẩm. Thiết kế độc đáo và đầy sáng tạo làm nổi bật "khí chất riêng" của sản phẩm khiến bất cứ khách hàng nào cũng muốn sở hữu. Những ý tưởng thiết kế tuyệt vời được phối hợp nhuần nhuyễn qua bàn tay của những người thợ có nhiều năm kinh nghiệm cùng với những chất liệu cao cấp nhất để tạo ra những sản phẩm không những chỉ tốt về chất lượng mà còn hợp thời trang, thẩm mỹ của người dùng.</p>
                        <p>Dbrand luôn cập nhật, phát triển theo xu hướng thời trang thế giới nhưng vẫn luôn giữ lại những nét đẹp trong thiết kế để tạo cho khách hàng những sản phẩm không chỉ sang trọng, đẳng cấp mà còn hợp thời trang, có tính thẩm mỹ.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-5">
                <div class="img-about-the-product">
                    <img src="./image/Thiet-ke-sang-tao.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="box-text-content">
                    ...
                    <div class="text-content">
                        <p>Dbrand với hệ thống 23 cửa hàng trên toàn quốc và tiếp tục mở rộng trong tương lai, chúng tôi mong muốn sẽ mang đến những sản phẩm đồ da chất lượng nhất cho khách hàng.</p>
                        <p>Dbrand – sản phẩm đồ da của người Việt.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="img-lookbook">
                        <a href="#">
                            ...
                            <div class="text-img-lookbook">
                                <span>All Bags Collection for Men in 2023</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="box-content-news">
                    <a href="index.php?page=detail_news_t1">
                        <div class="img-content-news">
                            <img src="./image/news/news (1).png" alt="">
                        </div>
                        <div class="name-content-new">
                            <span>Chiếc áo đấu của nhà vô địch Chung Kết Thế Giới 2023</span>
                        </div>
                        <div class="seen-more">
                            <span>Xem thêm</span>
                        </div>
